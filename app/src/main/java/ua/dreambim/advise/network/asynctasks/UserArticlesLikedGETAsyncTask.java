 ...
 */
public class UserArticlesLikedGETAsyncTask extends AsyncTask<String, Void, TheArticle[]> {
    /*
    strings[0] - nickname
     */

    private String getPath(String nickname){
        return "/users/" + nickname + "/articles/liked";
    }

    private UserProfileActivity activity;

    public UserArticlesLikedGETAsyncTask(UserProfileActivity activity){
